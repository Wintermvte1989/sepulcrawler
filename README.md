...
1. **Phase 1 (Fetch & Filter):** Lädt den Content aller definierten Ziel-URLs via `httpx` (mit IPv4-Transport-Fix) und extrahiert den Haupttext via `BeautifulSoup`.
...
* Google Gemini API Key (Pay-as-you-go empfohlen für höheres RPD-Limit)
